...
const defaultData = {
  products: [
    ...
    { id: 7, name: "Pollo Crujiente + Papas", price: 8000, mode: "solo_salsas", detail: "Pollo crujiente + papas fritas + salsas", image: "img/pollo_crujiente-papas.png", active: true }
  ],
  toppings: [
