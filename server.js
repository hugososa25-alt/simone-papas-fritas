...
const defaultData = {
  products: [
    ...
    { id: 6, name: "Pollo Crujiente", price: 6000, mode: "solo_salsas", detail: "Pollo crujiente + salsas", image: "img/milanesa.png", active: true },
    { id: 7, name: "Pollo Crujiente + Papas", price: 8000, mode: "solo_salsas", detail: "Pollo crujiente + papas fritas + salsas", image: "img/hero_box.png", active: true }
  ],
  toppings: [
    { id: 1, name: "Huevo picado en cubitos", image: "img/huevo_cubitos.png", active: true },
    { id: 2, name: "Mortadela en cubitos", image: "img/mortadela_cubitos.png", active: true },
    { id: 3, name: "Queso en cubitos", image: "img/queso_cubitos.png", active: true },
    { id: 4, name: "Paleta en cubitos", image: "img/paleta_cubitos.png", active: true },
    { id: 5, name: "Salchichas cortadas", image: "img/salchichas_cortadas.png", active: true },
    { id: 6, name: "Milanesa en cubitos", image: "img/milanesa_cubitos.png", active: true },
    { id: 7, name: "Salame milán en cubitos", image: "img/salame_cubitos.png", active: true },
